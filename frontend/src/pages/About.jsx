      ...
      <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden">
        ...
        <div className="p-8 sm:p-12 text-gray-700 leading-relaxed space-y-8 text-lg">
          ...
          <div className="mt-12 py-8 border-y border-gray-100">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
              <div className="flex flex-col items-center group">
                <div className="w-16 h-16 bg-yellow-100 rounded-full flex items-center justify-center text-3xl mb-4 group-hover:scale-110 transition-transform duration-300">
                  🏅
                </div>
          ...
          <div className="text-center mt-12 pt-8 border-t border-gray-100">
            ...
            <Link
              to="/"
              className="inline-block bg-yellow-600 text-white font-semibold px-8 py-4 rounded-full hover:bg-yellow-700 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1"
            >
