...
const OrderTimeline = ({ status }) => {
  ...
  if (isCancelled) {
    return (
      <div className="bg-red-50 border border-red-200 text-red-700 px-6 py-4 rounded-xl font-bold flex items-center justify-center gap-3 shadow-sm">
          ...
          return (
            <React.Fragment key={step}>
              ...
              <div className="flex flex-col items-center relative z-20 bg-white">
                <div
                  className={`w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center text-sm font-bold transition-all duration-500 shadow-sm
                    ...
                    ${isCurrent ? "scale-110 shadow-lg shadow-yellow-200" : ""}
                  `}
                >
                  {i < currentIndex ? (
              ...
              {/* Connector Line */}
              {!isLast && (
                <div className="flex-1 mx-2 sm:mx-4 h-1.5 rounded-full relative overflow-hidden bg-gray-100 z-0">
                  <div 
